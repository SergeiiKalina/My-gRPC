...
var greet_proto_greet_pb = require("../../greet/proto/greet_pb.js")

function serialize_greet_GreetRequest(arg) {
    if (!(arg instanceof greet_proto_greet_pb.GreetRequest)) {
...
function deserialize_greet_GreetRequest(buffer_arg) {
    return greet_proto_greet_pb.GreetRequest.deserializeBinary(
        new Uint8Array(buffer_arg)
    )
}

function serialize_greet_GreetResponse(arg) {
    if (!(arg instanceof greet_proto_greet_pb.GreetResponse)) {
...
function deserialize_greet_GreetResponse(buffer_arg) {
    return greet_proto_greet_pb.GreetResponse.deserializeBinary(
        new Uint8Array(buffer_arg)
    )
}
...
var GreetServiceService = (exports.GreetServiceService = {
    greet: {
        ...
        requestType: greet_proto_greet_pb.GreetRequest,
        responseType: greet_proto_greet_pb.GreetResponse,
...
exports.GreetServiceClient =
    grpc.makeGenericClientConstructor(GreetServiceService)
