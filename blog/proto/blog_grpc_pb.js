...
var blog_proto_blog_pb = require("../../blog/proto/blog_pb.js")
var google_protobuf_empty_pb = require("google-protobuf/google/protobuf/empty_pb.js")

function serialize_blog_Blog(arg) {
    if (!(arg instanceof blog_proto_blog_pb.Blog)) {
...
function deserialize_blog_Blog(buffer_arg) {
    return blog_proto_blog_pb.Blog.deserializeBinary(new Uint8Array(buffer_arg))
}

function serialize_blog_BlogId(arg) {
    if (!(arg instanceof blog_proto_blog_pb.BlogId)) {
...
function deserialize_blog_BlogId(buffer_arg) {
    return blog_proto_blog_pb.BlogId.deserializeBinary(
...
var BlogServiceService = (exports.BlogServiceService = {
    createBlog: {
        ...
        requestType: blog_proto_blog_pb.Blog,
        responseType: blog_proto_blog_pb.BlogId,
    ...
    readBlog: {
        ...
        requestStream: false,
        responseStream: false,
        requestType: blog_proto_blog_pb.BlogId,
        responseType: blog_proto_blog_pb.Blog,
...
exports.BlogServiceClient =
    grpc.makeGenericClientConstructor(BlogServiceService)
